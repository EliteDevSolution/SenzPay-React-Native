...
// create a component
class InternationalTopUpScreen extends Component {
  constructor(props) {
    super(props);
  ...
  onItemPress = (product) => () => {
    this.props.navigation.navigate('InternationalTopUpDetail', {product})
  }
...
const mapStateToProps = state => {
  const { internationalProducts } = state;
  return {
...
export default connect(mapStateToProps)(InternationalTopUpScreen);
