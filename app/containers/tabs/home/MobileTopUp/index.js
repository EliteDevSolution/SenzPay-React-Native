...
// create a component
class MobileTopUpScreen extends Component {
  constructor(props) {
    super(props);
  ...
  onItemPress = (product) => () => {
    this.props.navigation.navigate('MobileTopUpDetail', {product})
  }
...
export default connect(mapStateToProps)(MobileTopUpScreen);
